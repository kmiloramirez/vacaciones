...
public class SolicitudVacaciones {
	...
	public SolicitudVacaciones(Calendar fechaDeSolicitudDeinicio, Calendar fechaDeSolicitudFin, Calendar fechaDeRegreso,
			int cantidadDeDias, String jefeInmediato) {
